...
# 1) Debate reservation reclamation.
...
# 2) Regression coverage for reclaimed debate capacity.
...
# 3) Preserve cumulative per-step usage across retries in inspection.
...
# 4) Add inspection regression test for retry token accumulation.
...
# 5) Remove terminally failed live steps so they cannot remain visually working.
